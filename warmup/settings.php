<?php
    ...
    if (file_exists('../config.ini')) {
        header('Location: ../begin/register?set_name=' . urlencode($site_title)); exit;
    }
...
END;
        ...
        try {
            if ($fp = @fopen('../config.ini', 'w')) {
                fwrite($fp, $ini_file);
                fclose($fp);
                header('Location: ../begin/register'); exit;
            } else {
                include 'writeconfig.php'; exit;
            }
        } catch (Exception $e) {
            include 'writeconfig.php'; exit;
        }
    ...
    <div id="form-div">
        ...
        <form action="" method="post">
            <div class="settings-group">
                ...
                <p>
                    <label>
                        <small>Don't worry: you can change this at any time. You can even leave it blank for now if
                            you need more time.</small><br>
            ...
            <div class="settings-group">
                ...
                <p>
                    <label>
                        ...
                        <br>
                        <input type="text" name="upload_path" placeholder=""
