...
<a href="<?=$annotation['owner_url']?>"><img src="<?=$annotation['owner_image']?>" style="width: 100px; margin-left: 10px; margin-bottom: 10px" align="right"></a>Hi! We wanted to let you know that <strong><a href="<?=$annotation['owner_url']?>"><?=$annotation['owner_name']?></a></strong> replied to the post <strong><a href="<?=$post->getDisplayURL();?>"><?=$post->getNotificationTitle()?></a></strong>.<br>
<br>
