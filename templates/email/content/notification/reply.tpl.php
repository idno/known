<a href="<?=$vars['owner_url']?>"><img src="<?=$vars['owner_image']?>" style="width: 100px; margin-left: 10px; margin-bottom: 10px" align="right"></a>Hi! We wanted to let you know that <strong><a href="<?=$vars['owner_url']?>"><?=$vars['owner_name']?></a></strong> replied to the post <strong><a href="<?=$vars['object']->getDisplayURL();?>"><?=$vars['object']->getNotificationTitle()?></a></strong>.<br>
<br>
