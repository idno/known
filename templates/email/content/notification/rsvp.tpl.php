Hi! We wanted to let you know that <strong><a href="<?=$vars['owner_url']?>"><?=$vars['owner_name']?></a></strong> RSVPed to the event <strong><a href="<?=$vars['object']->getDisplayURL();?>"><?=$vars['object']->getNotificationTitle()?></a></strong>.<br>
<br>
