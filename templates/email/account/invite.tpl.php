...
<hr/>
<br>
Hi there! Your friend <strong><?php echo $vars['inviter']?></strong> has invited you to join
<a href="<?php echo \Idno\Core\Idno::site()->config()->getDisplayURL()?>" style="color: #73b2e3; text-decoration: none;"><?php echo \Idno\Core\Idno::site()->config()->title?></a>.
<br><br>
You can use this space to publish your stories, share things that interest you, and discuss things that matter.
<br><br>
Get started with <strong><?php echo \Idno\Core\Idno::site()->config()->title?></strong> by setting up your account.
<br><br>
<div align="center">
...
<a href="mailto:<?php echo \Idno\Core\Idno::site()->config()->from_email?>" style="color: #73b2e3; text-decoration: none;"><?php echo \Idno\Core\Idno::site()->config()->from_email?></a>.
<br><br>