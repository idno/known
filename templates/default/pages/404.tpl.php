<div class="container result-404">
    <div class="row" style="margin-bottom: 2em; margin-top: 6em">
        <div class="col-md-offset-1 col-md-5">
            ...
            <p><?= \Idno\Core\Idno::site()->language()->_("Maybe you'll find something interesting if you head back to the"); ?> <a href="<?=\Idno\Core\Idno::site()->config()->getDisplayURL()?>"><?=\Idno\Core\Idno::site()->config()->title?> <?= \Idno\Core\Idno::site()->language()->_('homepage'); ?></a>.
            </p>             
        </div>
        <div class="col-md-5">
