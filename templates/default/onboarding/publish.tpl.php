...
<div class="span6 offset3">
        ...
        <h2 style="text-align: center">
            Hi there, <a href="<?=\Idno\Core\site()->session()->currentUser()->getURL()?>"><?=\Idno\Core\site()->session()->currentUser()->getHandle()?></a>!
        </h2>
    ...
    <div class="span6 offset3 explanation">
        ...
        ?>
        <p style="text-align: center">
            You can also customize your site with <a href="<?=\Idno\Core\site()->config()->getURL()?>admin/themes">a theme</a>, or update your <a href="<?=\Idno\Core\site()->config()->getURL()?>account/settings">settings</a>.
        </p>
        <?php 
	        ...
	        ?>
	     <p style="text-align: center">
            You can also update your <a href="<?=\Idno\Core\site()->config()->getURL()?>account/settings">settings</a> or add to your <a href="<?=\Idno\Core\site()->session()->currentUser()->getURL()?>">profile</a>.
        </p>
	        <?php
