...
*/
        ...
        <span class="syndication-toggle">
            <input type="checkbox" name="syndication[]" class="checkbox" id="syndication_<?=$vars['service']?>_toggle" value="<?=$vars['service']?>" data-toggle="toggle" data-onstyle="info" data-on="<?=$human_icon?>&nbsp;<?=$human_name?>" data-off="<?=$human_icon?>&nbsp;<?=$human_name;?>">
        </span>
        <?php
