...
<div
    class="row idno-entry idno-entry-notification-reply notification <?= $notification->isRead() ? 'notification-read' : 'notification-unread' ?>">
    ...
    <div
        ...
        <div class="footer">
            <div class="permalink">
                ...
                <a href="<?= $annotation['owner_url'] ?>"><?= $annotation['owner_name'] ?></a> <?= $interaction ?> <a
                    href="<?= $post->getDisplayURL(); ?>"><?= $post->getNotificationTitle() ?></a>
