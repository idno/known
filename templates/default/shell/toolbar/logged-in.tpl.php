...
<!--<ul class="nav navbar-nav">-->
	<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href=""><?= htmlspecialchars(\Idno\Core\site()->session()->currentUser()->getTitle())?> <span class="caret"></span></a>
