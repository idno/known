...
?>
        ...
        <div class="pager">
            <ul>
                <?php if ($vars['offset'] > 0) { ?><li class="newer"><a href="<?=$this->getURLWithVar('offset', $prev_offset);?>" title="Newer" rel="next">&laquo; Newer</a></li><?php } ?>
                <?php if ($vars['offset'] <= $vars['count'] - $items_per_page) { ?><li class="older"><a href="<?=$this->getURLWithVar('offset', $next_offset);?>" title="Older" rel="prev">Older &raquo;</a></li><?php } ?>
            </ul>
        </div>
