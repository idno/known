<ul class="nav nav-tabs">
  ...
  <li <?php if ($_SERVER['REQUEST_URI'] == '/admin/homepage/') echo 'class="active"'; ?> role="presentation"><a href="<?=\Idno\Core\site()->config()->getDisplayURL()?>admin/homepage/" >Homepage</a></li>
  <li <?php if ($_SERVER['REQUEST_URI'] == '/admin/email/') echo 'class="active"'; ?> role="presentation"><a href="<?=\Idno\Core\site()->config()->getDisplayURL()?>admin/email/" >Email</a></li>
