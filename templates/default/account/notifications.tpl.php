<div class="row">
    <div class="col-lg-10 col-lg-offset-1">
        ...
        <h1<?php echo \Idno\Core\Idno::site()->language()->_('Notifications'); ?></h1>
        <p class="explanation">
            <?php echo \Idno\Core\Idno::site()->language()->_('The notifications screen shows you who has interacted with your content.'); ?>
        </p>
