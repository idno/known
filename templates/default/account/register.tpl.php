    ...
    <div class="col-md-8 col-md-offset-2">
        ...
        <div class="jumbotron">
            ...
            <form action="<?=\Idno\Core\Idno::site()->config()->getDisplayURL()?>account/register" method="post" style="width: 100%" class="form-horizontal">
                ...
                <div class="control-group">
                    <label class="control-label" for="inputEmail"><?= \Idno\Core\Idno::site()->language()->_('Create a password'); ?>
                        <br /><small><?= \Idno\Core\Idno::site()->language()->_('At least 7 characters please.'); ?></small></label>
                    
                    <div class="controls">
                        <input type="password" id="inputPassword" placeholder="<?= \Idno\Core\Idno::site()->language()->_('secret-password'); ?>" class="" style="width: 100%" name="password" >
                    </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="password" id="inputPassword" placeholder="<?= \Idno\Core\Idno::site()->language()->_('secret-password'); ?>" class="" style="width: 100%" name="password2">
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
