/**
 * This fork of the below was made by Ben Werdmuller at Known, Inc
 * Date: 2015-01-26
 *
 *
    ...
    var Renderer = function () {
        ...
        var tplButtonInfo = {
            picture: function (lang) {
                return tplIconButton('fa icon-picture', {
            ...
            link: function (lang) {
                return tplIconButton('fa icon-link', {
            ...
            table: function (lang) {
                var dropdown = '<ul class="note-table dropdown-menu">' +
                    ...
                    '</ul>';
                return tplIconButton('fa icon-table', {
            ...
            style: function (lang, options) {
                ...
                return tplIconButton('fa icon-magic', {
            ...
            color: function (lang) {
                var colorButtonLabel = '<i class="fa icon-font" style="color:black;background-color:yellow;"></i>';
            ...
            bold: function (lang) {
                return tplIconButton('fa icon-bold', {
                    event: 'bold',
                    title: lang.font.bold
                });
            },
            italic: function (lang) {
                return tplIconButton('fa icon-italic', {
                    event: 'italic',
                    title: lang.font.italic
                });
            },
            underline: function (lang) {
                return tplIconButton('fa icon-underline', {
                    event: 'underline',
                    title: lang.font.underline
                });
            },
            clear: function (lang) {
                return tplIconButton('fa icon-eraser', {
                    event: 'removeFormat',
                    title: lang.font.clear
                });
            },
            ul: function (lang) {
                return tplIconButton('fa icon-list-ul', {
                    event: 'insertUnorderedList',
                    title: lang.lists.unordered
                });
            },
            ol: function (lang) {
                return tplIconButton('fa icon-list-ol', {
                    event: 'insertOrderedList',
                    title: lang.lists.ordered
                });
            },
            paragraph: function (lang) {
                var leftButton = tplIconButton('fa icon-align-left', {
                    title: lang.paragraph.left,
                    event: 'justifyLeft'
                });
                var centerButton = tplIconButton('fa icon-align-center', {
                    title: lang.paragraph.center,
                    event: 'justifyCenter'
                });
                var rightButton = tplIconButton('fa icon-align-right', {
                    title: lang.paragraph.right,
                    event: 'justifyRight'
                });
                var justifyButton = tplIconButton('fa icon-align-justify', {
                    title: lang.paragraph.justify,
                    event: 'justifyFull'
                });

                var outdentButton = tplIconButton('fa icon-outdent', {
                    title: lang.paragraph.outdent,
                    event: 'outdent'
                });
                var indentButton = tplIconButton('fa icon-indent', {
                ...
                return tplIconButton('fa icon-align-left', {
            ...
            height: function (lang, options) {
                ...
                return tplIconButton('fa icon-text-height', {
            ...
            help: function (lang) {
                return tplIconButton('fa icon-question', {
            ...
            codeview: function (lang) {
                return tplIconButton('fa icon-code', {
                    event: 'codeview',
                    title: lang.options.codeview
                });
            },
            undo: function (lang) {
                return tplIconButton('fa icon-undo', {
                    event: 'undo',
                    title: lang.history.undo
                });
            },
            redo: function (lang) {
                return tplIconButton('fa icon-repeat', {
                    event: 'redo',
                    title: lang.history.redo
                });
            },
            hr: function (lang) {
                return tplIconButton('fa icon-minus', {
        ...
        var tplPopovers = function (lang, options) {
            var tplLinkPopover = function () {
                var linkButton = tplIconButton('fa icon-edit', {
                    title: lang.link.edit,
                    event: 'showLinkDialog',
                    hide: true
                });
                var unlinkButton = tplIconButton('fa icon-unlink', {
            ...
            var tplImagePopover = function () {
                ...
                var roundedButton = tplIconButton('fa icon-square', {
                    title: lang.image.shapeRounded,
                    event: 'imageShape',
                    value: 'img-rounded'
                });
                var circleButton = tplIconButton('fa icon-circle-o', {
                    title: lang.image.shapeCircle,
                    event: 'imageShape',
                    value: 'img-circle'
                });
                var thumbnailButton = tplIconButton('fa icon-picture-o', {
                    title: lang.image.shapeThumbnail,
                    event: 'imageShape',
                    value: 'img-thumbnail'
                });
                var noneButton = tplIconButton('fa icon-times', {
                    title: lang.image.shapeNone,
                    event: 'imageShape',
                    value: ''
                });

                var removeButton = tplIconButton('fa icon-trash-o', {
