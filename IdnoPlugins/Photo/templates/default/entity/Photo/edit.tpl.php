...
<form action="<?=$vars['object']->getURL()?>" method="post" enctype="multipart/form-data">
 ...
 <i class="icon-camera"></i> <span id="photo-filename">Select a photo</span> <input type="file" name="photo" id="photo" class="span9" accept="image/*;capture=camera" onchange="photoPreview(this)" />
            ...
            <p>
                <label>
                    Description<br />
                    <textarea name="body" id="description" class="span8 bodyInput mentionable" placeholder="Add a caption or include some #tags"><?=htmlspecialchars($vars['object']->description)?></textarea>
                </label>
            </p>
