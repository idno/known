<?php
     ...
     * implement the functions, and set known\Core\known->$db to be its
     * replacement.
     *
     * @package known
     * @subpackage core
    ...
    namespace known\Core {
        ...
        class DataConcierge extends \known\Common\Component
        {
            ...
            /**
             * Saves an known entity to the database, returning the _id
             * field on success.
             *
             * @param Entity $object
             */
            ...
            /**
             * Retrieves an known entity object by its UUID, casting it to the
             * correct class
             *
             * @param string $id
             * @return \known\Common\Entity | false
             */
            ...
            /**
             * Converts a database row into an known entity
             *
             * @param array $row
