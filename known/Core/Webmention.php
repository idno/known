<?php
    ...
    namespace known\Core {
        ...
        class Webmention extends \known\Common\Component
        {
            ...
            {
                \known\Core\site()->addPageHandler('/webmention/?', '\known\Pages\Webmentions\Endpoint');
            }
            ...
            static function pingMentions($pageURL, $text)
            {
                ...
                require_once \known\Core\site()->config()->path . '/external/mention-client-php/src/IndieWeb/MentionClient.php';
            ...
            static function getPageContent($url)
            {
                ...
                curl_setopt($ch, CURLOPT_USERAGENT, "known (webmentions) 0.1");
