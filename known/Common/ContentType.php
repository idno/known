<?php
    ...
    namespace known\Common {
        ...
        class ContentType extends Component
        {
            ...
            public $entity_class = 'known\\Entities\\Object';
            public $handler_class = 'known\\Common\\ContentType';
            ...
            function getIcon()
            {
                return \known\Core\site()->template()->draw('entity/' . $this->getEntityClassName() . '/icon');
            }
            ...
            function getEditURL()
            {
                return \known\Core\site()->config()->url . $this->camelCase($this->getEntityClassName()) . '/edit';
            }

            /**
             * Register a content type as being available to create / edit
             *
             * @param $class The string name of a class that extends known\Common\ContentType.
             * @return bool
             */
            static function register($class)
            {
                if (class_exists($class)) {
                    if (is_subclass_of($class, 'known\\Common\\ContentType')) {
