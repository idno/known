...
idno is under active development and an installable package is not yet available. It requires PHP 5.3+ with the MongoDB extension, Apache Web Server with the mod_rewrite extension, and MongoDB.
