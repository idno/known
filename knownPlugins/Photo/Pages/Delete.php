<?php
    ...
    namespace knownPlugins\Photo\Pages {
        ...
        class Delete extends \known\Common\Page {
            ...
            function getContent() {
                ...
                if (!empty($this->arguments)) {
                    $object = \knownPlugins\Photo\Photo::getByID($this->arguments[0]);
                } else {
                    // TODO 404
                    $this->forward();
                }
            ...
            function postContent() {
                ...
                if ($object->delete()) {
                    \known\Core\site()->session()->addMessage('Your photo was deleted.');
                } else {
                    \known\Core\site()->session()->addMessage("We couldn't delete your photo.");
                }
