    ...
    <div class="navbar-inner">
        <ul class="nav">
            ...
            */ 
            ...
            ?>
	        <li <?php if ($_SERVER['REQUEST_URI'] == '/account/settings/following/') echo 'class="active"'; ?>><a href="<?=\Idno\Core\site()->config()->getDisplayURL()?>account/settings/following/" >Following</a></li>
            <?php } ?>
